...
sub writeBlurb 
{
	...
	print WEBPAGE "\tbackground: $bkcolour;";
	print WEBPAGE "\tposition: fixed;\n\t}";
	print WEBPAGE "\t#left, #right {\n\t\ttop: 0; bottom: 0;\n\t\twidth: 15px;\n\t\t}";
	print WEBPAGE "\t#left { left: 0; }";
	print WEBPAGE "\t#right { right: 0; }";
	print WEBPAGE "\t#top, #bottom {\n\t\tleft: 0; right: 0;\n\t\theight: 15px;\n\t\t}";
	print WEBPAGE "\t#top { top: 0; }";
	print WEBPAGE "\t#bottom { bottom: 0; }";
    ...
    if (defined($page->{'vert_scrolling_div'}) or defined($page->{'hori_scrolling_div'})) 
	{
		...
		# print WEBPAGE "\t\talert(\"scrollLimit = \" + scrollLimit);\n";
		# print WEBPAGE "\t\talert(\"contheight = \" + contheight);\n";
		# print WEBPAGE "\t\talert(\"elemheight = \" + elemheight);\n";
		# print WEBPAGE "\t\talert(\"headerheight = \" + headerheight);\n";
