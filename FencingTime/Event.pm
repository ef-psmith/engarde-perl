...
has IsTeamEvent => (is => 'lazy', isa => Bool->plus_coercions(Any, q{ $_ eq "true" ? 1 : 0 }), coerce => 1);
...
has IsStarted => ( is => 'lazy', isa => Bool->plus_coercions(Any, q{ $_ eq "true" ? 1 : 0 }), coerce => 1);
...
has IsQualifier => ( is => 'lazy', isa => Bool->plus_coercions(Any, q{ $_ eq "true" ? 1 : 0 }), coerce => 1);
has AgeLimit => ( is => 'rwp', isa => Str );
has PointList2Abbr => ( is => 'lazy', isa => Str );
has IsFinished => ( is => 'rwp', isa => Bool->plus_coercions(Any, q{ !$_ eq "true" ? 1 : 0 }), coerce => 1);
